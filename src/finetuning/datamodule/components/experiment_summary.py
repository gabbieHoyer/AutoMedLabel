...
def extract_paths_and_count_slices(subjects, parquet_base_folder, sampling_rate=1, additional_paths=None):
    ...
    for subject_id in subjects:
        ...
        # Prefer 'npy256_mask_path'; if not available, use 'npy_mask_path'
        if 'npy256_mask_path' in sampled_df.columns:
            paths['gt_paths'].extend(sampled_df['npy256_mask_path'].tolist())
        elif 'npy_mask_path' in sampled_df.columns:
...
# ------------------ Dataset(s) characteristic summarization ----------------- #
