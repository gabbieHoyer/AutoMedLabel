...
from . import build_augmentation_pipeline

# ----------------- Dataset for Finetuning SAM or SAM2-based models ----------------- #
...
class mskSAM2Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        while attempt < max_attempts:
            ...
            # Compute the scale factor from image to mask.
            # Before transposition, img_1024 is assumed to have shape (H, W, 3)
            scale_factor = img_1024.shape[0] / gt2D.shape[0]
            ...
            if self.instance_bbox:
                ...
                bboxes = np.array([x_min, y_min, x_max, y_max]) * scale_factor #scale bbox from 256 to 1024
...
# ----------------- Dataset for Evaluating SAM or SAM2-based models ----------------- #
...
class MultiClassSAM2Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Compute the scale factor from image to mask.
        # Before transposition, img_1024 is assumed to have shape (H, W, 3)
        scale_factor = img_1024.shape[0] / gt.shape[0]
        ...
        for label_id in label_ids:
            ...
            if self.instance_bbox:
                ...
                for component in range(1, num_features + 1):
                    ...
                    bbox = np.array([x_min, y_min, x_max, y_max])* scale_factor #scale bbox from 256 to 1024
