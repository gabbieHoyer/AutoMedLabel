...
from src.preprocessing.metadata_management.metadata_extractors import generate_subject_metadata, extract_header_info, generate_slice_info_for_subject
...
def create_relevant_metadata_with_splits(nifti_image_dir:str, nifti_mask_dir:str, split_ratios:dict, \
    ...
    # import pdb; pdb.set_trace()  #gets through here
...
if __name__ == "__main__":
    ...
    parser.add_argument('--operation', type=str, required=True, choices=['A', 'B', 'C'], help='Select operation: A for statistics metadata, B for primary metadata with splits, C for slice parquet tables')
