...
from src.utils.file_management.medical_image_io import load_nifti
from src.utils.file_management.path_info import pair_files, get_base_name
...
class NiftiFigureInfo():
    ...
    def extract_save_path_info(self, fig_path:str, image_path:str):
        ...
        if fig_path.endswith(('.png', '.gif')):
            ...
            fname_no_ext = get_base_name(os.path.basename(image_path))
